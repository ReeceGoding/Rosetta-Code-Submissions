...
##"Iterative Solution"
#Not the most elegant, but certainly distinct from the other R solutions.
#The key is the observation that we need to produce n elements from left to right,
#then n-1 elements down, then n-1 left, then n-2 right, then n-2 down, ...
#This gives us two patterns. One in the direction that we need to write
#and another in the number of elements to write.
#After this, all that is left is battling R's indexing system.
