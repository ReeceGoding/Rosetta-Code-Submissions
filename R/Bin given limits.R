...
#Code such as 0:length(limits) is generally considered bad practice, but it didn't cause any problems here.
#To my amazement, this code works even if limits is of size 0 or 1. Even the <= printing doesn't break!
