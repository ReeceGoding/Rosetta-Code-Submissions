...
#Most of the battle is in figuring out exactly what the task wants.
#However, the hexadecimal requirement does increase the complexity.
#It is not often that an R user encounters such things.
