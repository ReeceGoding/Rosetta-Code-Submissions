...
#For our final answer, note that our choice to remove values from the vector 0:100 means our outputs will already be
...
#However, using seq without naming its arguments is considered bad practice.
#It works here, but breaking this code up is probably a better idea.